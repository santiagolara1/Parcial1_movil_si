...
@Composable
fun Agregar_view(navController: NavController,viewModel: Estudiantes_viewmodel){
    ...
    Scaffold(
        ...
        ContentAgregar_view(it, navController,viewModel)
    }

}

@Composable
fun ContentAgregar_view(it: PaddingValues, navController: NavController, viewModel: Estudiantes_viewmodel) {
    ...
    Column(
        ...
        Button(
            onClick = {
                val estudiante = Estudiantes_entidad(nombre = nombre, telefono = Telefono, email = email, Promedio = promedio.toFloat(), semestre = semestre.toInt())
